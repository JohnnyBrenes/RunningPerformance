...
values
  ('11111111-2201-4201-8201-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2100-4200-8200-111111111111', current_date, 'strength_mobility_plyometrics', 'mixed', 'Construir fuerza útil, control lateral y elasticidad de tobillo con técnica limpia.', 2700, 5, 7, 'Superficie estable', '8 min de movilidad dinámica y activación de pies.', 'Cinco bloques: activación, reactividad, fuerza de piernas, tren superior y accesorio.', '60–90 s entre series; 2 min antes de los pogos.', '5 min caminando y respiración tranquila.'),
...
values
  ('11111111-2301-4301-8301-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2201-4201-8201-111111111111', 1, 'mobility', 1, 'Activa el tronco antes de cargar. Controla la respiración y no compenses con el cuello.'),
  ('11111111-2302-4302-8302-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2201-4201-8201-111111111111', 2, 'main', 1, 'Reactividad con las piernas frescas, antes de la fuerza pesada. Aterrizajes silenciosos y postura alta.'),
  ('11111111-2303-4303-8303-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2201-4201-8201-111111111111', 3, 'main', 1, 'Fuerza del tren inferior con técnica estable. Deja dos o tres repeticiones limpias en reserva.'),
  ('11111111-2304-4304-8304-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2201-4201-8201-111111111111', 4, 'main', 1, 'Tren superior para sostener la postura en los kilómetros finales.'),
  ('11111111-2305-4305-8305-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2201-4201-8201-111111111111', 5, 'main', 1, 'Accesorio final de cuádriceps, sin llegar al fallo.'),
  ('22222222-2301-4301-8301-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2201-4201-8201-222222222222', 1, 'mobility', 1, 'Activa el tronco antes de cargar. Controla la respiración y no compenses con el cuello.'),
  ('22222222-2302-4302-8302-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2201-4201-8201-222222222222', 2, 'main', 1, 'Reactividad con las piernas frescas, antes de la fuerza pesada. Aterrizajes silenciosos y postura alta.'),
  ('22222222-2303-4303-8303-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2201-4201-8201-222222222222', 3, 'main', 1, 'Fuerza del tren inferior con técnica estable. Deja dos o tres repeticiones limpias en reserva.'),
  ('22222222-2304-4304-8304-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2201-4201-8201-222222222222', 4, 'main', 1, 'Tren superior para sostener la postura en los kilómetros finales.'),
  ('22222222-2305-4305-8305-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2201-4201-8201-222222222222', 5, 'main', 1, 'Accesorio final de cuádriceps, sin llegar al fallo.')
on conflict (id) do nothing;
end if;
end
$$;
...
values
  ('11111111-2401-4401-8401-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2301-4301-8301-111111111111', '11111111-1103-4103-8103-111111111111', 1, 2, null, null, 25, 30, null, null, 6, 3, null, 'each', '25 s por lado; corta si la cadera se cae.'),
  ('11111111-2402-4402-8402-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2301-4301-8301-111111111111', '11111111-1108-4108-8108-111111111111', 2, 2, 8, 10, null, 45, null, null, 6, 3, null, 'each', 'Resiste la rotación: el tronco no gira.'),
  ('11111111-2403-4403-8403-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2302-4302-8302-111111111111', '11111111-1104-4104-8104-111111111111', 1, 2, 20, 20, null, 90, null, null, 6, 4, null, null, 'Cuenta contactos; corta antes si dejan de ser silenciosos.'),
  ('11111111-2404-4404-8404-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2303-4303-8303-111111111111', '11111111-1101-4101-8101-111111111111', 1, 3, 8, 10, null, 75, null, null, 7, 3, '3-1-1', null, 'Carga que permita dos o tres repeticiones limpias en reserva.'),
  ('11111111-2405-4405-8405-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2303-4303-8303-111111111111', '11111111-1102-4102-8102-111111111111', 2, 3, 8, 10, null, 75, null, null, 7, 3, '3-1-1', null, 'Mantén la carga cerca de las piernas.'),
  ('11111111-2406-4406-8406-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2303-4303-8303-111111111111', '11111111-1105-4105-8105-111111111111', 3, 3, 8, 8, null, 60, 5, 'kg', 7, 3, null, 'each', 'Sube empujando con la pierna de arriba; baja controlando.'),
  ('11111111-2407-4407-8407-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2304-4304-8304-111111111111', '11111111-1106-4106-8106-111111111111', 1, 3, 8, 10, null, 60, null, null, 7, 3, null, null, 'Codos hacia el bolsillo; sin balanceo del tronco.'),
  ('11111111-2408-4408-8408-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2304-4304-8304-111111111111', '11111111-1107-4107-8107-111111111111', 2, 3, 8, 10, null, 60, null, null, 7, 3, null, null, 'Junta los omóplatos antes de tirar.'),
  ('11111111-2409-4409-8409-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2304-4304-8304-111111111111', '11111111-1109-4109-8109-111111111111', 3, 2, 10, 12, null, 60, null, null, 6, 4, null, null, 'Recorrido completo y sin bloquear los codos de golpe.'),
  ('11111111-2410-4410-8410-111111111111', '11111111-1111-4111-8111-111111111111', '11111111-2305-4305-8305-111111111111', '11111111-1110-4110-8110-111111111111', 1, 2, 12, 15, null, 60, null, null, 6, 4, null, null, 'Para la serie si aparece molestia en la rodilla.'),
  ('22222222-2401-4401-8401-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2301-4301-8301-222222222222', '22222222-1103-4103-8103-222222222222', 1, 2, null, null, 25, 30, null, null, 6, 3, null, 'each', '25 s por lado; corta si la cadera se cae.'),
  ('22222222-2402-4402-8402-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2301-4301-8301-222222222222', '22222222-1108-4108-8108-222222222222', 2, 2, 8, 10, null, 45, null, null, 6, 3, null, 'each', 'Resiste la rotación: el tronco no gira.'),
  ('22222222-2403-4403-8403-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2302-4302-8302-222222222222', '22222222-1104-4104-8104-222222222222', 1, 2, 20, 20, null, 90, null, null, 6, 4, null, null, 'Cuenta contactos; corta antes si dejan de ser silenciosos.'),
  ('22222222-2404-4404-8404-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2303-4303-8303-222222222222', '22222222-1101-4101-8101-222222222222', 1, 3, 8, 10, null, 75, null, null, 7, 3, '3-1-1', null, 'Carga que permita dos o tres repeticiones limpias en reserva.'),
  ('22222222-2405-4405-8405-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2303-4303-8303-222222222222', '22222222-1102-4102-8102-222222222222', 2, 3, 8, 10, null, 75, null, null, 7, 3, '3-1-1', null, 'Mantén la carga cerca de las piernas.'),
  ('22222222-2406-4406-8406-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2303-4303-8303-222222222222', '22222222-1105-4105-8105-222222222222', 3, 3, 8, 8, null, 60, 5, 'kg', 7, 3, null, 'each', 'Sube empujando con la pierna de arriba; baja controlando.'),
  ('22222222-2407-4407-8407-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2304-4304-8304-222222222222', '22222222-1106-4106-8106-222222222222', 1, 3, 8, 10, null, 60, null, null, 7, 3, null, null, 'Codos hacia el bolsillo; sin balanceo del tronco.'),
  ('22222222-2408-4408-8408-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2304-4304-8304-222222222222', '22222222-1107-4107-8107-222222222222', 2, 3, 8, 10, null, 60, null, null, 7, 3, null, null, 'Junta los omóplatos antes de tirar.'),
  ('22222222-2409-4409-8409-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2304-4304-8304-222222222222', '22222222-1109-4109-8109-222222222222', 3, 2, 10, 12, null, 60, null, null, 6, 4, null, null, 'Recorrido completo y sin bloquear los codos de golpe.'),
  ('22222222-2410-4410-8410-222222222222', '22222222-2222-4222-8222-222222222222', '22222222-2305-4305-8305-222222222222', '22222222-1110-4110-8110-222222222222', 1, 2, 12, 15, null, 60, null, null, 6, 4, null, null, 'Para la serie si aparece molestia en la rodilla.')
on conflict (id) do nothing;
end if;
end
$$;
